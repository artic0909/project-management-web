    ...
    <main class="page-area" id="pageArea">
        <div class="page" id="page-project-show">
            ...
            <div class="page-header">
                <div>
                    <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px;">
                        @php
                            $statusClass = strtolower(str_replace(' ', '-', $project->projectStatus->name ?? 'new'));
                        @endphp
                        <span class="proj-status {{ $statusClass }}">{{ $project->projectStatus->name ?? 'New' }}</span>
            ...
            <div class="dash-grid">
                ...
                {{-- Right Column: Team, Dates, Tasks Status --}}
                    ...
                    <div class="dash-card" style="border: 2px solid var(--accent);box-shadow: 0 10px 30px rgba(99,102,241,0.1);">
                        ...
                        <div class="card-body" style="padding:20px;">
                            ...
                            <div style="text-align:center;">
                                ...
                                <div style="width:100%;height:10px;background:var(--bg4);border-radius:10px;overflow:hidden;margin-bottom:15px;">
                                    <div style="width:{{ $perc }}%;height:100%;background:linear-gradient(90deg, var(--accent), var(--accent2));"></div>
                                </div>
                                <div style="display:flex;justify-content:space-between;font-size:13px;color:var(--t2);">
                                    <span>Assigned: <strong>{{ $total }}</strong></span>
                                    <span>Finished: <strong style="color:var(--accent)">{{ $done }}</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
