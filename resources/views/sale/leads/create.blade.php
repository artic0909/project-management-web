                ...
                <div class="span-8" style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div class="dash-card" style="margin-top:16px;">
                        <div class="card-head" style="padding:16px 18px; border-bottom:1px solid var(--b1);">
                            <div class="card-title">Lead Notes History</div>
                        </div>
                        <div class="card-body" style="padding:18px;">
                            <div style="position:relative;">
                                <textarea name="notes" class="form-inp" rows="5" placeholder="Add initial lead note..." style="border-radius:12px; font-size:13px; min-height:120px;"></textarea>
                            </div>
                        </div>
                    </div>
