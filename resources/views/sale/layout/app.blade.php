        ...
        <header class="topbar" id="topbar">
            <div class="topbar-left">
                ...
                <div class="page-breadcrumb">
                    <span class="breadcrumb-panel" id="activePanelLabel">Sales Panel</span>
            ...
            <div class="topbar-right">
                ...
                <div class="user-menu" id="userMenu">
                    <a class="um-item" href="{{ route('sale.account-settings') }}"><i class="bi bi-person-fill"></i> My Profile</a>
                    <hr class="um-divider">
