...
<main class="page-area" id="pageArea">
    ...
    <div class="page" id="page-dashboard">
        ...
        <div class="kpi-card" style="--kpi-accent:#06b6d4"><div class="kpi-top"><div class="kpi-icon" style="background:rgba(6,182,212,.15);color:#06b6d4"><i class="bi bi-bullseye"></i></div><span class="kpi-trend up"><i class="bi bi-arrow-up-right"></i> 5%</span></div><div class="kpi-value">73%</div><div class="kpi-label">My Marketing Orders</div></div>
        </div>
    </div>
