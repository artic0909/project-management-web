...
<main class="page-area" id="pageArea">
    <div class="page">
        ...
        <form action="{{ route('sale.orders.update', $order->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="dash-card" style="position:sticky;top:80px;overflow:visible;">
                        ...
                        <div class="card-body">
                            ...
                            <div style="display:flex;flex-direction:column;gap:8px;">
                                ...
                                <a href="{{ route('sale.orders.index') }}" class="btn-ghost" style="width:100%;justify-content:center;padding:10px;text-decoration:none;">
                                    Cancel
                                </a>
                            </div>
