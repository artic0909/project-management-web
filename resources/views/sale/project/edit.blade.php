...
<main class="page-area" id="pageArea">
    <div class="page" id="page-project-edit">
        ...
        <form action="{{ route('sale.projects.update', $project->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="dash-grid">
...
@include('sale.project._multiselect_assets')
@include('sale.project._order_select_assets')
@include('sale.project._phone_email_assets')
