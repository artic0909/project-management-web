    ...
    <div class="page" id="page-dashboard">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('sale.payments.index') }}" class="btn-ghost"><i class="bi bi-arrow-left"></i> Back to Payments</a>
            </div>
        </div>
        ...
        <div class="dash-grid">
            ...
            <div class="span-8">
                ...
                <div class="dash-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sale.payments.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div style="display:flex;flex-direction:column;gap:12px">
                            ...
                            <div style="background:var(--bg3);border:1px solid var(--b1);border-radius:var(--r-sm);padding:14px;position:relative; transition: var(--transition);" onmouseover="this.style.borderColor='var(--accent)'" onmouseout="this.style.borderColor='var(--b1)'">
                                <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:6px">
                                    ...
                                    <form action="{{ route('sale.payments.destroy', $pay->id) }}" method="POST" onsubmit="return confirm('Delete this payment entry?')">
                                        @csrf
                                        @method('DELETE')
