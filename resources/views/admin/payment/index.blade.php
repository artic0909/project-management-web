                ...
                <div class="table-wrap">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>3</td>
                                <td><span class="mono">#ORD-2849</span></td>
                                <td>
                                    <div class="lead-cell">
                                        <div class="mini-ava" style="background:linear-gradient(135deg,#10b981,#3b82f6)">GL</div>
                                        <div>
                                            <div class="ln">GreenLeaf Retail</div>
                                            <div class="ls">accounts@greenleaf.com</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="ln">Suresh Patel</div>
                                    <div class="ls">9876543210</div>
                                </td>
                                <td>
                                    <div class="ls">20 Jan 2025</div>
                                </td>
                                <td><span class="date-cell danger">28 Feb 2025</span></td>
                            ...
                            <tr>
                                <td>4</td>
                                <td><span class="mono">#ORD-2850</span></td>
                                <td>
                                    <div class="lead-cell">
                                        <div class="mini-ava" style="background:linear-gradient(135deg,#f59e0b,#ef4444)">BL</div>
                                        <div>
                                            <div class="ln">BlueSky Logistics</div>
                                            <div class="ls">billing@bluesky.co</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="ln">Meena Kapoor</div>
                                    <div class="ls">9001234567</div>
                                </td>
                                <td>
                                    <div class="ls">01 Feb 2025</div>
                                </td>
                                <td><span class="date-cell ok">01 Apr 2025</span></td>
                                <td><span class="money-cell">₹5,50,000</span></td>
                                <td><span class="money-cell" style="color:#10b981">₹2,75,000</span></td>
                                <td><span class="money-cell" style="color:#ef4444">₹2,75,000</span></td>
                                <td><span class="status-pill pending">Pending</span></td>
                                <td>
                                    <div class="ln">Dev Nair</div>
                                </td>
                                <td>
                                    <div class="row-actions">
                                        <button class="ra-btn" onclick="openModal('PaymentDetailModal')"><i class="bi bi-eye-fill"></i></button>
                            ...
                            <tr>
                                <td>5</td>
                                <td><span class="mono">#ORD-2851</span></td>
                                <td>
                                    <div class="lead-cell">
                                        <div class="mini-ava" style="background:linear-gradient(135deg,#ec4899,#f59e0b)">AP</div>
                                        <div>
                                            <div class="ln">Apex Pharma Ltd</div>
                                            <div class="ls">finance@apexpharma.in</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="ln">Vijay Reddy</div>
                                    <div class="ls">9123456789</div>
                                </td>
                                <td>
                                    <div class="ls">05 Feb 2025</div>
                                </td>
                                <td><span class="date-cell ok">05 Mar 2025</span></td>
                                <td><span class="money-cell">₹9,80,000</span></td>
                                <td><span class="money-cell" style="color:#10b981">₹9,80,000</span></td>
                                <td><span class="money-cell" style="color:#10b981">₹0</span></td>
                                <td><span class="status-pill paid">Paid</span></td>
                                <td>
                                    <div class="ln">Priya Mehta</div>
        ...
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <div class="modal-bd">
                <div class="form-grid">
                    ...
                    <div class="form-row"><label class="form-lbl">Payment Terms</label>
    ...
    <div class="modal-backdrop" id="deleteModal">
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <div class="modal-bd" style="text-align:center;padding:32px 24px;">
                ...
                <h3 style="margin:0 0 8px;font-size:18px;font-weight:600;">Are you sure?</h3>
                <p style="margin:0;font-size:14px;color:#6b7280;line-height:1.6;">Are you sure you want to delete this Payment?<br>This action <strong style="color:#dc2626;">cannot be undone.</strong></p>
            </div>
    ...
    <div class="modal-backdrop" id="PaymentDetailModal">
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <div class="modal-ft">
                ...
                <button class="btn-primary-solid" onclick="closeModal('PaymentDetailModal')">Update</button>
            </div>
        </div>
    </div>
