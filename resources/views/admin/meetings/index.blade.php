                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($meeting->meeting_type == 'lead' && $meeting->lead)
                                                <a href="{{ route($routePrefix . '.leads.show', $meeting->lead_id) }}"
                                                    class="m-link active" style="font-size:12px;"><i
                                                        class="bi bi-person-circle"></i> {{ $meeting->lead->company ?? 'N/A' }}</a>
                                            ...
                                            @elseif($meeting->meeting_type == 'project' && $meeting->project)
                                                ...
                                                @endforeach
                                            @else
                                                <span style="font-size:12px; color:var(--t4);">N/A</span>
                                            @endif
                                        </td>
                                        <td>
                                            <div style="font-weight:800; color:var(--t1); line-height:1.4;">
                                                {{ $meeting->meeting_title ?: 'N/A' }}</div>
                                        </td>
                                        <td>
                                            <div class="m-desc-cell"
                                                title="{{ $meeting->meeting_description ?: 'N/A' }}">
                                                {{ \Illuminate\Support\Str::limit($meeting->meeting_description ?: 'N/A', 100) }}
                                            </div>
                                        </td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            <div class="p-item">
                                                ...
                                                <span class="p-email">{{ $meeting->createdBy->email ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td>
