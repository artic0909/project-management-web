                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-row">
                                    ...
                                    <div style="display: flex; align-items: stretch;">
                                        ...
                                        <input type="text" name="invoice_no" value="{{ old('invoice_no', $invoice->invoice_no) }}" class="form-inp" style="border-top-left-radius: 0; border-bottom-left-radius: 0; flex: 1; height: 42px;" required>
                                    </div>
                                </div>
                                <div class="form-row">
