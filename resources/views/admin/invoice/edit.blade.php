    ...
    <div class="page" id="page-invoice-edit">
        <div class="page-header">
            <div>
                ...
                <p class="page-desc">Modify details for Invoice #STW{{ $invoice->invoice_no }}</p>
            </div>
                            ...
                            <div class="invoice-grid">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="input-prefix-group">
                                        ...
                                        <input type="text" name="invoice_no" value="{{ old('invoice_no', $invoice->invoice_no) }}" class="form-inp prefix-input font-mono" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="6" inputmode="numeric" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row full-span">
                                    ...
                                    <input type="text" name="client_name" id="client_name" value="{{ old('client_name', $invoice->client_name) }}" class="form-inp" placeholder="Client or Company Name" required>
                                </div>
                                <div class="form-row full-span">
                                    <label class="form-lbl">Client Address</label>
                                    <textarea name="client_address" id="client_address" class="form-inp" rows="2" placeholder="Full client address...">{{ old('client_address', $invoice->client_address) }}</textarea>
                                </div>
                                <div class="form-row">
                                    <label class="form-lbl">Client GSTIN</label>
                                    <input type="text" name="client_gstin" value="{{ old('client_gstin', $invoice->client_gstin) }}" class="form-inp" placeholder="e.g. 29AAAAA0000A1Z5">
                                </div>
                                <div class="form-row">
                                    <label class="form-lbl">Place of Supply</label>
                                    <input type="text" name="place_of_supply" id="place_of_supply" value="{{ old('place_of_supply', $invoice->place_of_supply) }}" class="form-inp" placeholder="State/Location">
                                </div>
                                <div class="form-row full-span">
                            ...
                            <div class="table-responsive-wrapper">
                                <table class="table" id="itemsTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="item-row">
                                            <td><input type="text" name="items[{{ $idx }}][desc]" class="form-inp sm" value="{{ $item['desc'] }}" placeholder="Item description" required></td>
                                            <td><input type="text" name="items[{{ $idx }}][hsn]" class="form-inp sm" value="{{ $item['hsn'] ?? '' }}" placeholder="HSN/SAC"></td>
                                            <td><input type="number" name="items[{{ $idx }}][qty]" class="form-inp sm qty font-mono" value="{{ $item['qty'] }}" min="0.01" step="any" oninput="calcRow(this)"></td>
                                            <td><input type="number" name="items[{{ $idx }}][rate]" class="form-inp sm rate font-mono" value="{{ $item['rate'] }}" min="0" step="any" oninput="calcRow(this)"></td>
                                            <td><input type="number" name="items[{{ $idx }}][amount]" class="form-inp sm amount font-mono" value="{{ $item['amount'] }}" readonly></td>
                        ...
                        <div class="card-body">
                            <div class="summary-container">
                                <div class="summary-row">
                                    ...
                                    <span class="summary-val font-mono">₹<span id="subtotal_text">{{ number_format($invoice->subtotal, 2) }}</span></span>
                                ...
                                <div class="summary-row tax-row">
                                    ...
                                    <div class="tax-input-wrap">
                                        ...
                                        <input type="number" id="cgst_p" class="form-inp sm tax-inp font-mono" value="{{ round($cgst_p, 2) }}" min="0" step="any" oninput="calcTotals()">
                                        <span class="tax-val font-mono">₹<span id="cgst_text">{{ number_format($invoice->cgst, 2) }}</span></span>
                                ...
                                <div class="summary-row tax-row">
                                    ...
                                    <div class="tax-input-wrap">
                                        ...
                                        <input type="number" id="sgst_p" class="form-inp sm tax-inp font-mono" value="{{ round($sgst_p, 2) }}" min="0" step="any" oninput="calcTotals()">
                                        <span class="tax-val font-mono">₹<span id="sgst_text">{{ number_format($invoice->sgst, 2) }}</span></span>
                                ...
                                <div class="summary-row tax-row">
                                    ...
                                    <div class="tax-input-wrap">
                                        ...
                                        <input type="number" id="igst_p" class="form-inp sm tax-inp font-mono" value="{{ round($igst_p, 2) }}" min="0" step="any" oninput="calcTotals()">
                                        <span class="tax-val font-mono">₹<span id="igst_text">{{ number_format($invoice->igst, 2) }}</span></span>
                                        <input type="hidden" name="igst" id="igst_val" value="{{ $invoice->igst }}">
                                    </div>
                                </div>
                                <div class="summary-row tax-row">
                                    <label class="summary-label" for="adjustment">Adjustment (₹)</label>
                                    <input type="number" name="adjustment" id="adjustment" class="form-inp sm adj-inp font-mono" value="{{ $invoice->adjustment }}" step="any" oninput="calcTotals()">
                                </div>
                                <div class="summary-divider"></div>
                                <div class="summary-row total-row">
                                    <span>Grand Total</span>
                                    <span class="total-val font-mono">₹<span id="total_text">{{ number_format($invoice->total, 2) }}</span></span>
                        ...
                        <div class="card-body">
                            <div class="bank-grid">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" name="bank_details[account_number]" class="form-inp sm font-mono" value="{{ $invoice->bank_details['account_number'] ?? '44128332491' }}">
                                </div>
                                <div class="form-row">
                                    <label class="form-lbl sm-lbl">IFSC Code</label>
                                    <input type="text" name="bank_details[ifsc]" class="form-inp sm font-mono" value="{{ $invoice->bank_details['ifsc'] ?? 'SBIN0003242' }}">
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" name="bank_details[swift]" class="form-inp sm font-mono" value="{{ $invoice->bank_details['swift'] ?? 'SBININBB812' }}">
                                </div>
                            </div>
                        </div>
                    </div>
