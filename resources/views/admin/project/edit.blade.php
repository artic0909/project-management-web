                        ...
                        <div class="card-body">
                            <div class="form-grid">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="number" name="domain_renewal_price" class="form-inp" placeholder="₹ Amount" step="0.01" min="0" value="{{ old('domain_renewal_price', $project->domain_renewal_price) }}">
                    ...
                    <div class="dash-card">
                        ...
                        <div class="card-body" style="display:flex;flex-direction:column;gap:14px;">
                            ...
                            <div class="form-row">
                                ...
                                <input type="number" name="no_of_pages" class="form-inp" min="1" value="{{ old('no_of_pages', $project->no_of_pages) }}" required>
