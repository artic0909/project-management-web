...
{
    protected $fillable = [
        'order_id', 'project_name', 'client_name', 'email', 'phone',
        'company_name', 'starting_date', 'plan_name', 'payment_status',
        'username', 'password', 'no_of_mail_ids', 'mail_password',
        'domain_server_book', 'full_address', 'domain_name',
        'hosting_provider', 'cms_platform', 'cms_custom', 'no_of_pages',
        'website_payment_status', 'required_features', 'reference_websites',
        'last_update_date', 'client_feedback_summary', 'internal_notes',
        'project_start_date', 'expected_delivery_date', 'actual_delivery_date',
        'project_status', 'project_price', 'advance_payment',
        'remaining_amount', 'financial_payment_status', 'invoice_number',
